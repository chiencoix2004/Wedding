<!-- Main Wraapper -->
    ...
    <!-- Countdown Start -->
    <section>
        <div class="pe_coundown_wrapper">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                        <div class="pe_countdown_body">
                            <p class="pe_coundown_text1">Deal of the week</p>
                            <h2 class="pe_coundown_heading">Get upto <span style="color: #1fbdd3;">40%</span> Off On
                                Order OF <span style="color: #1fbdd3;">$90</span></h2>
                            <div id="countdown">
                                <ul>
                                    <li><span class="pe_no_count" id="days"></span><span class="pe_count_name">days</span></li>
                                    <li><span class="pe_no_count" id="hours"></span><span class="pe_count_name">Hours</span></li>
                                    <li><span class="pe_no_count" id="minutes"></span><span class="pe_count_name">Minutes</span></li>
                                    <li><span class="pe_no_count" id="seconds"></span><span class="pe_count_name">Seconds</span></li>
                                </ul>
                            </div>
                            <div class="pe_countdown_button pe_btn"><a href="collection.html">Shop Now</a></div>
                        </div>
                    </div>
    ...
    <div class="pe_categories_wrapper">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="pe_categories_left_img">
                        <div class="grid-item">
                            <div class="grid_img">
                                <img class="img-fluid" src="assets/images/category_img1.jpg" alt="images" />
                                <div class="pe_categories_btn"><a href="product_detail.html">Clothings</a></div>
                                <div class="grid_more"></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="pe_categories_left_imgs">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="pe_categories_left_img">
                                    <div class="grid-item">
                                        <div class="grid_img">
                                            <img class="img-fluid" src="assets/images/category_img2.jpg" alt="images" />
                                            <div class="pe_categories_btn"><a href="product_detail.html">Footwear</a></div>
                                            <div class="grid_more"></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="pe_categories_left_img">
                                    <div class="grid-item">
                                        <div class="grid_img">
                                            <img class="img-fluid" src="assets/images/category_img3.jpg" alt="images" />
                                            <div class="pe_categories_btn"><a href="product_detail.html">Watches</a>
                                            </div>
                                            <div class="grid_more"></div>
                                        </div>
                                    </div>
                        ...
                        <div class="pe_categories_img4">
                            <div class="pe_categories_left_img">
                                <div class="grid-item">
                                    <div class="grid_img">
                                        <img class="img-fluid" src="assets/images/category_img4.jpg" alt="images" />
                                        <div class="pe_categories_btn"><a href="product_detail.html">Accessories</a>
                                        </div>
                                        <div class="grid_more"></div>
                                    </div>
                                </div>
    ...
    <!-- products Start -->
    <section>
        <div class="pe_product_wrapper">
            <div class="container">
                <div class="pe_product_heading_filter">
                    <div class="pe_product_heading pe_heading">
                        <h2>OUR <span style="color: #1fbdd3;">PRODUCTS</span></h2>
                    </div>
                    <div class="work_filter_menu">
                        <button class="filter" data-filter="all">All</button>
                        <button class="filter" data-filter=".women">Women</button>
                        <button class="filter" data-filter=".man">Man</button>
                        <button class="filter" data-filter=".accessories">Accessories</button>
                    </div>
                </div>
                <div class="case_filter">
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-12 col-12 mix all women">
                            <div class="work_porfolio_section wow zoomIn" data-wow-delay="0.1s">
                                <a href="product_detail-2.html"><img src="assets/images/filter_img1.jpg" alt="" /></a>
                                <div class="pe_discount_tag">
                                    <p>-40%</p>
                                </div>
                                <div class="pe_product_name">
                                    <a href="product_detail.html">
                                        <p>Dummy Product <span>Name</span></p>
                                    </a>
                                    <div class="pe_product_ratings">
                                        <p><img src="assets/images/star.svg" alt="images" /></p>
                                        <p><img src="assets/images/star.svg" alt="images" /></p>
                                        <p><img src="assets/images/star.svg" alt="images" /></p>
                                        <p><img src="assets/images/star.svg" alt="images" /></p>
                                        <p><img src="assets/images/star.svg" alt="images" /></p>
                                    </div>
                                    <div class="pe_product_price"><span class="pe_product_price1">$40.00</span>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 col-12 mix all man">
                            <div class="work_porfolio_section wow zoomIn" data-wow-delay="0.1s">
                                <img src="assets/images/filter_img2.jpg" alt="images" />
                                <div class="pe_product_name">
                                    <a href="product_detail.html">
                                        <p>Dummy Product <span>Name</span></p>
                                    </a>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 col-12 mix all women">
                            <div class="work_porfolio_section wow zoomIn" data-wow-delay="0.1s">
                                <img src="assets/images/filter_img3.jpg" alt="" />
                                <div class="pe_discount_tag">
                                    <p>SALE</p>
                                </div>
                                <div class="pe_product_name">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 col-12 mix all man">
                            <div class="work_porfolio_section wow zoomIn" data-wow-delay="0.1s">
                                <img src="assets/images/filter_img4.jpg" alt="" />
                                <div class="pe_discount_tag">
                                    <p>SALE</p>
                                </div>
                                <div class="pe_product_name">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 col-12 all man">
                            <div class="work_porfolio_section wow zoomIn" data-wow-delay="0.1s">
                                <img src="assets/images/filter_img5.jpg" alt="" />
                                <div class="pe_product_name">
                                    <a href="product_detail.html">
                                        <p>Dummy Product <span>Name</span></p>
                                    </a>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 col-12 mix all women">
                            <div class="work_porfolio_section wow zoomIn" data-wow-delay="0.1s">
                                <img src="assets/images/filter_img6.jpg" alt="" />
                                <div class="pe_discount_tag">
                                    <p>-60%</p>
                                </div>
                                <div class="pe_product_name">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 col-12 mix all man">
                            <div class="work_porfolio_section wow zoomIn" data-wow-delay="0.1s">
                                <img src="assets/images/filter_img7.jpg" alt="" />
                                <div class="pe_product_name">
                                    <a href="product_detail.html">
                                        <p>Dummy Product <span>Name</span></p>
                                    </a>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 col-12 mix all women">
                            <div class="work_porfolio_section wow zoomIn" data-wow-delay="0.1s">
                                <img src="assets/images/filter_img8.jpg" alt="" />
                                <div class="pe_product_name">
                                    <a href="product_detail.html">
                                        <p>Dummy Product <span>Name</span></p>
                                    </a>
    ...
    <!-- New Arrivals Start -->
    <section>
        <div class="pe_new_arrivals_wrapper">
            <div class="container">
                <div class="pe_product_heading_filter pe_arrival_heading_arw">
                    <div class="pe_arrival_heading pe_heading">
                        <h2>NEW <span style="color: #1fbdd3;">ARRIVALS</span></h2>
                    </div>



                    <div class="pe_arrival_slider_arrow">
                        <div class="swiper-button-prev">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12">
                                    <path d="M2.653,6L6.561,1.92a0.617,0.617,0,0,0,0-.844L6.218,0.719a0.556,0.556,0,0,0-.808,0L0.757,5.578a0.621,0.621,0,0,0,0,.847l4.649,4.854a0.556,0.556,0,0,0,.808,0l0.342-.357a0.617,0.617,0,0,0,0-.844Z" />
                                </svg>
                            </span>
                        </div>
                        <div class="swiper-button-next">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12">
                                    <path d="M4.347,6L0.439,1.92a0.617,0.617,0,0,1,0-.844l0.342-.358a0.556,0.556,0,0,1,.808,0L6.243,5.578a0.622,0.622,0,0,1,0,.847L1.594,11.279a0.556,0.556,0,0,1-.808,0l-0.342-.357a0.617,0.617,0,0,1,0-.844Z" />
                                </svg>
                            </span>
                        </div>
                    </div>
                </div>
                <div class="pe_new_arrivals_slider">
                    <!-- Swiper -->
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="work_porfolio_section wow zoomIn" data-wow-delay="0.1s">
                                    <img src="assets/images/filter_img1.jpg" alt="" />
                                    <div class="pe_product_name">
                                        <a href="product_detail.html">
                                            <p>Dummy Product <span>Name</span></p>
                                        </a>
                            ...
                            <div class="swiper-slide">
                                <div class="work_porfolio_section wow zoomIn" data-wow-delay="0.1s">
                                    <img src="assets/images/filter_img2.jpg" alt="" />
                                    <div class="pe_product_name">
                                        <a href="product_detail.html">
                                            <p>Dummy Product <span>Name</span></p>
                                        </a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="pe_services_body">
                            ...
                            <div class="pe_services_box">
                                <div class="pe_services_icon pe_services_icon3">
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="25" viewBox="0 0 30 25">
                                            <path data-name="Forma 1" d="M29.062,16.068a0.917,0.917,0,0,0-.937.893v6.252H1.875V12.5H12.187a0.894,0.894,0,1,0,0-1.786H1.875V7.137H12.187a0.894,0.894,0,1,0,0-1.786H1.875A1.833,1.833,0,0,0,0,7.137V23.213A1.833,1.833,0,0,0,1.875,25h26.25A1.833,1.833,0,0,0,30,23.213V16.961A0.917,0.917,0,0,0,29.062,16.068Zm-20.625,0H4.687a0.894,0.894,0,1,0,0,1.787h3.75A0.894,0.894,0,1,0,8.437,16.068ZM29.432,2.743L22.869,0.064a1,1,0,0,0-.741,0L15.566,2.743A0.894,0.894,0,0,0,15,3.565V7.137c0,4.914,1.907,7.786,7.033,10.6a0.98,0.98,0,0,0,.934,0C28.093,14.931,30,12.058,30,7.137V3.565A0.893,0.893,0,0,0,29.432,2.743ZM28.125,7.137c0,4.125-1.433,6.4-5.625,8.788-4.192-2.4-5.625-4.669-5.625-8.788V4.154l5.625-2.3,5.625,2.3V7.137ZM25.9,5.546a0.976,0.976,0,0,0-1.318.139L21.634,9.2,20.468,7.536a0.969,0.969,0,0,0-1.3-.248,0.868,0.868,0,0,0-.261,1.238l1.875,2.68a0.956,0.956,0,0,0,.741.4h0.039a0.957,0.957,0,0,0,.733-0.335L26.046,6.8A0.865,0.865,0,0,0,25.9,5.546Z" />
                                        </svg>
                                    </span>
                                </div>
                                <div class="pe_services_content">
    ...
    <div class="pe_sale_banner_wrapper">
        <div class="container">
            <div class="row">
                    ...
                    <div class="pe_sale_banner_one">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                <div class="pe_sale_one_img"><img src="assets/images/sale_img1.png" alt="images" />
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="pe_sale_banner_two">
                        <div class="row">
                            <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                <div class="pe_sale_two_content">
                                    <p class="pe_sale_two_t1">summer</p>
                                    <p class="pe_sale_two_t2">surprise</p>
                                    <p class="pe_sale_two_t3">sale</p>
                                    <p class="pe_sale_one_text4">Flat <span>40 %</span></p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                <!-- <div class="pe_sale_two_img">
                                       <img src="assets/images/sale_img2.png">
                                       </div> -->
                            </div>
                        </div>
                    </div>
    ...
    <!--fashion Slider Start -->
    <div class="pe_fashion_wrapper">
        <div class="container-fluid">
            <div class="pe_fashion_section">
                <!-- Swiper -->
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="pe_fashion_img_section">
                                <div class="pe_fashion_img"><img src="assets/images/slider_img1.jpg" alt="images" />
                                </div>
                                <div class="pe_fashion_img_overlay">
                                    <div class="pe_fashion_like">
                                        <span>
                                    ...
                                    <div class="pe_fashion_cmt">
                                        <span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="18" viewBox="0 0 20 18">
                                                ...
                                                <path data-name="Forma 1" class="cls-1" d="M14.54,0.537A6.48,6.48,0,0,0,9.952,2.429,6.48,6.48,0,0,0,5.365.537C2.218,0.537,0,3.235,0,6.419,0,11.342,5.073,15.1,9.6,17.348a0.8,0.8,0,0,0,.711,0c4.526-2.245,9.6-6,9.6-10.929C19.9,3.241,17.692.537,14.54,0.537Zm-4.587,15.3c-3.815-1.947-8.4-5.274-8.4-9.415,0-2.28,1.479-4.38,3.81-4.38A4.949,4.949,0,0,1,9.3,4a0.788,0.788,0,0,0,1.306,0A4.958,4.958,0,0,1,14.54,2.039c2.332,0,3.81,2.1,3.81,4.38C18.349,10.558,13.759,13.891,9.952,15.834Z" />
                                            </svg>
                                        </span>
                                        <span>150</span>
                                    </div>
                        ...
                        <div class="swiper-slide">
                            <div class="pe_fashion_img_section">
                                <div class="pe_fashion_img"><img src="assets/images/slider_img2.jpg" alt="images" />
                                </div>
                                <div class="pe_fashion_img_overlay">
                                    <div class="pe_fashion_like">
                                        <span>
                        ...
                        <div class="swiper-slide">
                            <div class="pe_fashion_img_section">
                                <div class="pe_fashion_img"><img src="assets/images/slider_img3.jpg" alt="images" />
                                </div>
                                <div class="pe_fashion_img_overlay">
                                    <div class="pe_fashion_like">
                                        <span>
                        ...
                        <div class="swiper-slide">
                            <div class="pe_fashion_img_section">
                                <div class="pe_fashion_img"><img src="assets/images/slider_img4.jpg" alt="images" />
                                </div>
                                <div class="pe_fashion_img_overlay">
                                    <div class="pe_fashion_like">
                                        <span>
                        ...
                        <div class="swiper-slide">
                            <div class="pe_fashion_img_section">
                                <div class="pe_fashion_img"><img src="assets/images/slider_img5.jpg" alt="images" />
                                </div>
                                <div class="pe_fashion_img_overlay">
                                    <div class="pe_fashion_like">
                                        <span>
                        ...
                        <div class="swiper-slide">
                            <div class="pe_fashion_img_section">
                                <div class="pe_fashion_img"><img src="assets/images/slider_img6.jpg" alt="images" />
                                </div>
                                <div class="pe_fashion_img_overlay">
                                    <div class="pe_fashion_like">
                                        <span>
                        ...
                        <div class="swiper-slide">
                            <div class="pe_fashion_img_section">
                                <div class="pe_fashion_img"><img src="assets/images/slider_img7.jpg" alt="images" />
                                </div>
                                <div class="pe_fashion_img_overlay">
                                    <div class="pe_fashion_like">
                                        <span>
                        ...
                        <div class="swiper-slide">
                            <div class="pe_fashion_img_section">
                                <div class="pe_fashion_img"><img src="assets/images/slider_img8.jpg" alt="images" />
                                </div>
                                <div class="pe_fashion_img_overlay">
                                    <div class="pe_fashion_like">
                                        <span>
                        ...
                        <div class="swiper-slide">
                            <div class="pe_fashion_img_section">
                                <div class="pe_fashion_img"><img src="assets/images/slider_img9.jpg" alt="images" />
                                </div>
                                <div class="pe_fashion_img_overlay">
                                    <div class="pe_fashion_like">
                                        <span>
